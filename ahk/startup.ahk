...
keyboard_data := [
	...
	unset, "𝐚", "𝐬", "𝐝", "𝐟", "𝐠", "𝐡", "𝐣", "𝐤", "𝐥", "", "", unset,
	unset, "𝐳", "𝐱", "𝐜", "𝐯", "𝐛", "𝐧", "𝐦", "", "", "", "𝐚𝐛𝐜"],
	["", "", "", "", "", "", "", "", "", "", "", "", "", unset,
	unset, "𝐐", "𝐖", "𝐄", "𝐑", "𝐓", "𝐘", "𝐔", "𝐈", "𝐎", "𝐏", unset, unset, unset,
	unset, "𝐀", "𝐒", "𝐃", "𝐅", "𝐆", "𝐇", "𝐉", "𝐊", "𝐋", "", "", unset,
	unset, "𝐙", "𝐗", "𝐂", "𝐕", "𝐁", "𝐍", "𝐌", "", "", "", "𝐀𝐁𝐂"]],
	...
	unset, "𝐴", "𝑆", "𝐷", "𝐹", "𝐺", "𝐻", "𝐽", "𝐾", "𝐿", "", "", unset,
	unset, "𝑍", "𝑋", "𝐶", "𝑉", "𝐵", "𝑁", "𝑀", "", "", "", "𝐴𝐵𝐶"]],

	[["", "", "", "", "", "", "", "", "", "", "", "", "", unset,
	unset, "𝒒", "𝒘", "𝒆", "𝒓", "𝒕", "𝒚", "𝒖", "𝒊", "𝒐", "𝒑", unset, unset, unset,
	unset, "𝒂", "𝒔", "𝒅", "𝒇", "𝒈", "𝒉", "𝒋", "𝒌", "𝒍", "", "", unset,
	unset, "𝒛", "𝒙", "𝒄", "𝒗", "𝒃", "𝒏", "𝒎", "", "", "", "𝒂𝒃𝒄"],
	["", "", "", "", "", "", "", "", "", "", "", "", "", unset,
	unset, "𝑸", "𝑾", "𝑬", "𝑹", "𝑻", "𝒀", "𝑼", "𝑰", "𝑶", "𝑷", unset, unset, unset,
	unset, "𝑨", "𝑺", "𝑫", "𝑭", "𝑮", "𝑯", "𝑱", "𝑲", "𝑳", "", "", unset,
	unset, "𝒁", "𝑿", "𝑪", "𝑽", "𝑩", "𝑵", "𝑴", "", "", "", "𝑨𝑩𝑪"]],

	[["", "", "", "", "", "", "", "", "", "", "", "", "", unset,
	unset, "𝓆", "𝓌", "ℯ", "𝓇", "𝓉", "𝓎", "𝓊", "𝒾", "ℴ", "𝓅", unset, unset, unset,
	unset, "𝒶", "𝓈", "𝒹", "𝒻", "ℊ", "𝒽", "𝒿", "𝓀", "𝓁", "", "", unset,
	unset, "𝓏", "𝓍", "𝒸", "𝓋", "𝒷", "𝓃", "𝓂", "", "", "", "𝒶𝒷𝒸"],
	["", "", "", "", "", "", "", "", "", "", "", "", "", unset,
	unset, "𝒬", "𝒲", "ℰ", "ℛ", "𝒯", "𝒴", "𝒰", "ℐ", "𝒪", "𝒫", unset, unset, unset,
	unset, "𝒜", "𝒮", "𝒟", "ℱ", "𝒢", "ℋ", "𝒥", "𝒦", "ℒ", "", "", unset,
	unset, "𝒵", "𝒳", "𝒞", "𝒱", "ℬ", "𝒩", "ℳ", "", "", "", "𝒜ℬ𝒞"]],

	[["", "𝟙", "𝟚", "𝟛", "𝟜", "𝟝", "𝟞", "𝟟", "𝟠", "𝟡", "𝟘", "", "", unset,
	unset, "𝕢", "𝕨", "𝕖", "𝕣", "𝕥", "𝕪", "𝕦", "𝕚", "𝕠", "𝕡", unset, unset, unset,
	unset, "𝕒", "𝕤", "𝕕", "𝕗", "𝕘", "𝕙", "𝕛", "𝕜", "𝕝", "⨟", "⫾", unset,
	unset, "𝕫", "𝕩", "𝕔", "𝕧", "𝕓", "𝕟", "𝕞", "ⅆ", "ⅇ", "ⅈ", "𝕒𝕓𝕔"],
	["", "", "", "", "", "", "", "", "", "", "", "", "", unset,
	unset, "ℚ", "𝕎", "𝔼", "ℝ", "𝕋", "𝕐", "𝕌", "𝕀", "𝕆", "ℙ", unset, unset, unset,
	unset, "𝔸", "𝕊", "𝔻", "𝔽", "𝔾", "ℍ", "𝕁", "𝕂", "𝕃", "", "⫿", unset,
	unset, "ℤ", "𝕏", "ℂ", "𝕍", "𝔹", "ℕ", "𝕄", "ⅅ", "", "ⅉ", "𝔸𝔹ℂ"]],
