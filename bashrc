...
export PATH=$HOME/local/bin:$HOME/bin:$PATH:/usr/local/texlive/2014/bin/x86_64-linux
...
##cat /usr/local/texlive/2014/install-tl.log # Never try this!
#echo -e "\e[1;4m~/scripts/\e[0m"
#dir -B --color $HOME/scripts/
#echo
